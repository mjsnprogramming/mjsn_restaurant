            ...
            <Header/>    
                ...
                <div id = "howItWorks">
                    ...
                    {/*<div id = "pageChooseCircles">
                        ...
                        <div id = "one" className = "pageChooseCircles" tabIndex={0}>
                            <span>1</span>
                        </div>

                        <div id = "two" className = "pageChooseCircles" tabIndex={0}>
                            <span>2</span>
                        </div>

                        <div id = "three" className = "pageChooseCircles" tabIndex={0}>
                            <span>3</span>
                        </div>

                        <div id = "four" className = "pageChooseCircles" tabIndex={0}>
                            <span>4</span>
                        </div>

                        <div id = "five" className = "pageChooseCircles" tabIndex={0}>
                            <span>5</span>
                        </div>
...
/*const getStarted = document.getElementById('#getStartedButton');
    ...
    getStarted.addEventListener('click', () => {
        howItWorks.scrollIntoView(true);
    })*/
export default Home;